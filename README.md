...
| [`windows.iso`](https://github.com/YorkWaugh/vmware_tools_backup/releases/download/Archives/windows.iso) | 13.1.5-25544008 |
...
* **Guest OS Mapping:** [`isoimages_manifest.txt`](isoimages_manifest.txt) (from Workstation 26H1u1 (26.0.1.25688693), included in this repository)
